...
## What is it?
A **Sensor** is a device that detects and responds to some type of input from the physical environment. Think of sensors as the "eyes, ears, and skin" of a machine. They take a physical stimulus—like heat, light, pressure, or a specific chemical—and convert it into an electrical signal that a computer or a human can understand. Your smartphone is packed with sensors, including an accelerometer to know which way you're holding it and a light sensor to adjust the screen brightness.
