---
title: Columnar Liquid Crystals
---

# Columnar Liquid Crystals

## What are Columnar Liquid Crystals?
**Columnar Liquid Crystals (CLCs)** represent a unique state of matter that exists somewhere between a rigid solid and a fluid liquid. Imagine a stack of coins. In CLCs, flat, disc-shaped molecules stack tightly on top of each other to form long, microscopic columns. 

While these columns organize themselves into highly structured two-dimensional patterns (like a hexagonal honeycomb grid), the individual molecules *inside* each column remain relatively disordered and fluid. They can spin and slide over one another, much like a liquid. This gives CLCs the remarkable ability to flow while maintaining a highly organized, wire-like internal framework.
